...
_default_messages = {
    ...
    'CONFIRM_REGISTRATION': (
        _('Thank you. Confirmation instructions '
          'have been sent to %(email)s. If you do not see this email soon, please check your junk email folder.'),
        'success'),
    'EMAIL_CONFIRMED': (
    ...
    'CONFIRMATION_REQUEST': (
        _('Confirmation instructions have been sent to %(email)s. If you do not see this email soon, please check your junk email folder.'), 'info'),
    'CONFIRMATION_EXPIRED': (
        _('You did not confirm your email within %(within)s. '
          'New instructions to confirm your email have been sent '
          'to %(email)s. If you do not see this email soon, please check your junk email folder.'), 'error'),
    'LOGIN_EXPIRED': (
        _('You did not login within %(within)s. New instructions to login '
          'have been sent to %(email)s. If you do not see this email soon, please check your junk email folder.'), 'error'),
    'LOGIN_EMAIL_SENT': (
        _('Instructions to login have been sent to %(email)s. If you do not see this email soon, please check your junk email folder.'), 'success'),
    'INVALID_LOGIN_TOKEN': (
...
def _get_i18n_domain(app):
    return Domain(
        pkg_resources.resource_filename('openagua.security', 'translations'),
